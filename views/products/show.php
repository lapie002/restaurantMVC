...
<!-- le script de validation de formulaire qui se trouve dans /js/validation/form.js -->   
    ...
    <div id="wrapper">
            ...
            <div id="page-wrapper">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 class="page-header">
                                        Formulaire de mise a jour d'un Produit
                                    </h1>
                                </div>
                            </div>
                            <!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <!-- doit on garder les method et l action -->
                                    <form role="form" method="get" action="" name="myForm" onsubmit="return validate();">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="title" id="title" value="<?=$product->getTitle();?>">
                                        </div>

                                        <div class="form-group">
                                            <label>Text area</label>
                                            <textarea class="form-control" rows="3" name="text" id="text"><?=$product->getText();?></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label>le prix</label>
                                            <input class="form-control" type="number" name="price" id="price" value="<?=$product->getPrice();?>" step="any" min="0" required>
                                        </div>

                                        <div class="form-group">
                                            <label>la date</label>
                                            <input class="form-control" type="date" name="productDate" id="productDate" value="<?=$product->getProductDate();?>">
                                        </div>
