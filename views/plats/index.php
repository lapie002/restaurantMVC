                            ...
                            <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                        ...
                                                        <td><?=$plat->getImage();?></td>
                                                        <td><?=$plat->getPrix();?></td>
                                                        <td><a href='?controller=plats&action=show&id=<?=$plat->getId();?>'><button type="button" class="btn btn-sm btn-warning"><i class="fa fa-minus" aria-hidden="true"></i></button></a></td>
                                                              ...
                                                              <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-content">
                                                                  ...
                                                                  <div class="modal-footer">
                                                                    <a href='?controller=plats&action=delete&id=<?=$num;?>'><button type="button" class="btn btn-default">Delete</button></a>
